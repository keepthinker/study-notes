...
![virtual-memory](D:\git\study-notes\操作系统\virtual-memory.png)
...
![page-table](D:\git\study-notes\操作系统\page-table.png)
...
![process-virtual-physical-memory](D:\git\study-notes\操作系统\process-virtual-physical-memory.png)

The operating maintains a separate page table for each process in the system.
...
![cache-computer](D:\git\study-notes\操作系统\cache-computer.png)
